                ...
                <li class="mr-3 flex-1">
                    <router-link :to="{}"
                        ...
                        <i class="fas fa-tasks pr-0 md:pr-3"></i><span
                            class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Mes
                            Quiz</span>
                    </router-link>
                </li>
                <li class="mr-3 flex-1">
                    <router-link :to="{ name: 'createQuiz' }"
                        ...
                        <i class="fa fa-envelope pr-0 md:pr-3"></i><span
                            class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Creer
                            des Quiz</span>
                    </router-link>
                </li>
                <li class="mr-3 flex-1">
